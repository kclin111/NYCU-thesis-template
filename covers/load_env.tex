...
% TW-Kai 是 Overleaf 內建字體, 本機 (MiKTeX/TeX Live) 通常沒有.
% 找不到就退回 Windows 內建的標楷體 DFKai-SB, 兩邊都能編.
\IfFontExistsTF{TW-Kai}{
  \setCJKmainfont[AutoFakeBold={4}, AutoFakeSlant=0.2]{TW-Kai}
  \setCJKmonofont[AutoFakeBold={4}, AutoFakeSlant=0.2]{TW-Kai}
}{
  \setCJKmainfont[AutoFakeBold={4}, AutoFakeSlant=0.2]{DFKai-SB}
  \setCJKmonofont[AutoFakeBold={4}, AutoFakeSlant=0.2]{DFKai-SB}
}
